    ...
    internal  open inner class Async :
        ...
        override fun doInBackground(vararg params: String?): String? {
            try {
                ...
                Log.e("TRANSLATE", "In Translate exception UEE" + e.message + e.cause)

                e.printStackTrace()
            } catch (e: MalformedURLException) {
                e.printStackTrace()
                Log.e("TRANSLATE", "In Translate exception MUE" + e.message + e.cause)

            } catch (e: IOException) {
                e.printStackTrace()
                Log.e("TRANSLATE", "In Translate exception IO" + e.message + e.cause)

            } catch (e: Exception) {
                Log.e("TRANSLATE", "In Translate exception" + e.message + e.cause)
                e.printStackTrace()
            }
            return null
        }
